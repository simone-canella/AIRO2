(define (domain warehouse_domain_1)
  ...
  (:process carrying
    ...
    :precondition (and (not (= ?rob1 ?rob2)) (inTransit ?obj) (moving-loaded ?rob1 ?from ?to) (carryingCrate ?rob1 ?obj) (not (linkedWith ?rob1 ?rob2)) (not (linkedWith ?rob1 ?rob2)))
